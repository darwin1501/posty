...
@section('content')
    <div class="flex justify-center">
        <div class="w-4/12 bg-white p-12 rounded-lg">
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password" id="password" placeholder="Choose a pasword"
                    class="bg-gray-100 border-2 w-full p-4 rounded-lg
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Re-type your password"
                    class="bg-gray-100 border-2 w-full p-4 rounded-lg
